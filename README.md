# 2-tier-web-app-1
2 Tiered Web App with IIS and DB
...
<p>
This template allows you to deploy a Web application a VM set. It also configures the Web Application to set the  database server.
